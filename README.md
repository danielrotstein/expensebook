...
Project Link: [https://gitlab.com/george.franco/expensebook] (https://gitlab.com/george.franco/expensebook)
...
```
cd existing_repo
git remote add origin https://gitlab.com/george.franco/expensebook.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/george.franco/expensebook/-/settings/integrations)

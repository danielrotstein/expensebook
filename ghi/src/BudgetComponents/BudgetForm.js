                ...
                <form onSubmit={(e) => handleSubmit(e)} className="create-budget-form">
                    {step == 1
                        ? <div className="create-budget-card">
                            <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="#70c244" class="bi bi-currency-exchange budget-form-icon" viewBox="0 0 16 16">
                    ...
                    {step == 2
                        ? <div className="create-budget-card">
                            <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="#70c244" class="bi bi-calendar-day budget-form-icon" viewBox="0 0 16 16">
                    ...
                    {step == 3
                        ? <div className="create-budget-card">
                            <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="#70c244" class="bi bi-piggy-bank budget-form-icon" viewBox="0 0 16 16">
                    ...
                    {step == 4
                        ? <div className="create-budget-card mb-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="65" height="65" fill="#70c244" class="bi bi-airplane-engines budget-form-icon" viewBox="0 0 16 16">
